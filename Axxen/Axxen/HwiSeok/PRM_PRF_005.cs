...
namespace Axxen
{
    public partial class PRM_PRF_005 : Axxen.GridForm
    {
        ...
        private void PRM_PRF_005_Load(object sender, EventArgs e)
        {
            ...
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차그룹명", "GV_Group", true, 100, DataGridViewContentAlignment.MiddleCenter, false);
            ...
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차상태", "GV_Status", true, 100, DataGridViewContentAlignment.MiddleCenter, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차수량", "GV_Qty", true, 100, DataGridViewContentAlignment.MiddleRight, false);
            ...
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "로딩작업장", "Loading_Wc", true, 120, DataGridViewContentAlignment.MiddleCenter, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩일자", "Unloading_date", true, 120, DataGridViewContentAlignment.MiddleCenter, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩시간", "Unloading_time", true, 120, DataGridViewContentAlignment.MiddleCenter, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩작업장", "Unloading_Wc", true, 150, DataGridViewContentAlignment.MiddleCenter, false);
