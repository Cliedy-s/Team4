...
namespace Axxen
{
    public partial class PRM_PRF_006 : Axxen.GridForm
    {
        ...
        private void PRM_PRF_006_Load(object sender, EventArgs e)
        {
            ...
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "로딩수량", "Loading_Qty", true, 100, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "로딩시간", "Loading_time", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "로딩작업장", "Loading_Wc", true, 100, default, false);
            ...
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩수량", "Unloading_Qty", true, 100, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩일자", "Unloading_date", true, 100, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩일시", "Unloading_datetime", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "언로딩작업장", "Unloading_wc", true, 120, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대상대차코드", "Target_GV", true, 120, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차비우기일자", "Clear_Date", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차비우기일시", "Clear_Datetime", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차비우기수량", "Clear_Qty", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대차비우기원인", "Clear_Cause", true, 150, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대상작업장", "Clear_wc", true, 100, default, false);
            DatagridviewDesigns.AddNewColumnToDataGridView(dgvMainGrid, "대상작업장품목", "Clear_Item", true, 150, default, false);
            #endregion
